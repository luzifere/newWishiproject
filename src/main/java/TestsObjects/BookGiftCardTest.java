...
public class BookGiftCardTest extends setup
{
    String newusermaile;
    int number;
    ...
    public void SelectGift() {
        ...
        gift.ClickUnlimitedButton();
        this.unlimited = gift.GetTextUnlimited();
    ...
    {
        GiftPage gift = new GiftPage(driver);
        String totalgift = gift.GetTotalgiftPayment();
        String pricecardCO = gift.GetPriceCaerdCheckOut();
        Assert.assertEquals(unlimited, totalgift);
        Assert.assertEquals(unlimited, pricecardCO);
        ...
        gift.ClickBuyButton();
        String pricecardConfirm = gift.GetPriceCaerdConfirm();
